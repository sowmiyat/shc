									...
									<div class="row invoice-info">
										<div class="col-md-4 col-sm-4 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="billing_customer" name="name" value="<?php if(isset($bill_fdata)){ echo $bill_fdata->customer_name; } ?>" class="customer_check"/>
												</div>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-12">
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="billing_mobile" name="mobile" class="form-control has-feedback-left"  value="<?php if(isset($bill_fdata)){ echo $bill_fdata->mobile; } ?>" maxlength="10" onkeypress="return isNumberKey(event)" style="padding-right: 5px;">
										...
										<div class="col-md-4 col-sm-4 col-xs-12 landline_mobile">
											<div class="form-group">
												...
												<div class="col-md-6 col-sm-6 col-xs-12">
													<input type="text" id="billing_landline_mobile" name="landline" class="form-control has-feedback-left"  value="<?php if(isset($bill_fdata)){ echo $bill_fdata->landline; } ?>" maxlength="8" onkeypress="return isNumberKey(event)" >
													...
													<tbody class="bill_lot_add_retail" id="bill_lot_add_retail">
														...
														if($bill_data['ordered_data']) {
															...
															foreach ($bill_ldata as $c_value) {
	 															...
	 															<td class="td_subtotal">'.$c_value->sub_total.'</td> <input type="hidden" value ="'.$c_value->sub_total.'" name="customer_detail['.$i.'][subtotal]" class="sub_total"/><td><a href="#" class="retail_sub_delete">Delete</a></td></tr>';
