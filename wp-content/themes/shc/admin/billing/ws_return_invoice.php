                ...
                <div class="x_title">
                    <form action="<?php menu_page_url('ws_return_items'); ?>" method="GET">
                        <h2>Invoice
                            ...
                            <input type="hidden" name="rtn_id" class="return_invoice_id" value="<?php echo $bill_fdata->id; ?>">
                        ...
                        <div class="x_content">
                            ...
                            <section class="content invoice" id="ws_billing_return">
                               ...
                               <!--  <div class="row">
                                ...
                                <div class="row">
                                    <B>Product Name :</B>                                   
                                    <select name="lot_number" class="rtn_ws_lot_id" id="rtn_ws_lot_id" tabindex="-1" aria-hidden="true" />
                                    </select>
                                ...
                                <div class="row"> 
                                    <div class="">
                                        <button class="btn btn-success add-button-return"  id="">ADD</button>
                                    </div>
                                </div>
                                                        ...
                                                        <td>
                                                            <div class="form-horizontal form-label-left input_mask" style="position:relative;">
                                                                <div class="col-xs-12 col-md-8 col-lg-6 form-group has-feedback nopadding">
                                                                    <input type="text" class="form-control ws_rtn_fsub_total" readonly name="ws_rtn_fsub_total">
                                ...
                                <div class="row no-print">
                                    <div class="col-xs-12">
                                        ...
                                        <input type="hidden" name="id" class="invoice_id_new" value="<?php echo $bill_fdata->id; ?>">
                                            <button class="btn btn-success pull-right" id="ws_return_submit"><i class="fa fa fa-edit"></i> Submit Goods Return</button>
                                        <?php
                                            } else {
                                        ?>
