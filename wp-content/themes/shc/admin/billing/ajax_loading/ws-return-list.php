                ...
                <table class="table table-striped jambo_table bulk_action">
                    ...
                    ?>
                                <tr class="odd pointer">
									...
									<a href="<?php echo admin_url('admin.php?page=ws_return_items')."&return_id=$b_value->id&id=$b_value->search_inv_id&year=$b_value->financial_year"; ?>" class="bill_view_update">Update</a>/
									<a href="#" class="ws_return_print">Print</a>/
									<a href="#" class="print_bill_delete delete-ws-return-bill" data-id="<?php echo $b_value->id; ?>">Delete</a>
