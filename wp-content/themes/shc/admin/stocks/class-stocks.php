<?php
	class Stocks {
		...
		function stock_list_pagination( $args ) {
		    ...
		    $query 				= "SELECT l.*, s.id as stock_id, s.stock_count, s.selling_total, s.created_at as stock_created FROM ${stock_table} as s JOIN ${lots_table} as l ON s.lot_number = l.id WHERE s.active = 1 and l.active=1 ${condition}";
