...
<html>
    ...
    <meta charset="utf-8">
        <style>
            ...
            body {
                ...
                @media print {
            dt { 
                float: left; clear: left; text-align: right; font-weight: bold; margin-right: 10px; } 
   ...
   <table cellspacing='3' cellpadding='3' WIDTH='100%' class="table table-striped" style=" border-collapse: collapse;border: 1px solid black; width:400px;margin: 0 auto;margin-bottom:20px;">
      <thead>
          <tr class="">
              <th style="border: 1px solid black;align:center">Cash</th>
              <th style="border: 1px solid black;align:center">Card</th>
              <th style="border: 1px solid black;align:center">Cheque</th>
              <th style="border: 1px solid black;align:center">Internet <br/>Banking</th>
              <th style="border: 1px solid black;align:center">Credit</th>
			  <th style="border: 1px solid black;align:center">COD</th>
              <th style="border: 1px solid black;align:center">Total Sale</th>
			  <th style="border: 1px solid black;align:center">Total Due</th>
          </tr>
      </thead>
      <tbody>
          <tr> <?php  $cash_amount = $c_result->amt- $payto_result->pay_to; ?>
				<td style="border: 1px solid black;align:center" ><?php echo $cash_amount; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $card_result->amt; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $cheque_result->amt; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $interbanking_result->amt; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $cr_result->amt; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $s_result->cod; ?></td>
                <td style="border: 1px solid black;align:center" ><?php echo $s_result->total_amount; ?></td>
                <td style="border: 1px solid black;align:center" ><?php 
    ...
    ?>
            <tr>
                ...
                <td style="border: 1px solid black;" ><?php echo $b_value->inv_id; ?></td>
